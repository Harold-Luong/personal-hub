...
function CategorySpendingWorkspace({ categories, mode, userId }) {
...
export default function CategorySpendingPage({ categories = [], mode = "mobile", navItems = [], onNavigate, user }) {
    if (mode === "desktop") {
        return (
            <div className="web-dashboard-view web-category-spending-view">
                ...
                <main className="web-dashboard-view__main web-category-spending-view__main">
                    <CategorySpendingWorkspace categories={categories} mode={mode} userId={user?.uid} />
                </main>
            </div>
        );
    }

    return <CategorySpendingWorkspace categories={categories} mode={mode} userId={user?.uid} />;
}
